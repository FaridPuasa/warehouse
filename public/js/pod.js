...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    function createPODTemplate() {
        ...
        if (($("#productTemp").val().length != 0) && ($("#podDateTemp").val().length != 0) && ($("#completionDateTemp").val().length != 0)
            ...
            if (document.getElementById("agentTemp").value == "1464207") {
                document.getElementById("agentName").value = "IFR AINA";
            }
            ...
            if (document.getElementById("agentTemp").value == "1485342") {
                document.getElementById("agentName").value = "EFR RIDZWAN";
            }
            
            if (document.getElementById("agentTemp").value == "1486903") {
                document.getElementById("agentName").value = "EFR HANADY";
            }
