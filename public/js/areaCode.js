let address = document.getElementById("address_4").toUpperCase()
//let district = document.getElementById("district").toUpperCase()
...
document.getElementById("demo").value = area;
